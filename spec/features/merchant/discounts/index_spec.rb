...
RSpec.describe "As a merchant employee" do
  before :each do
    ...
    @discount_3 = @merchant_2.discounts.create(name: "crazy discount", percentage: 10, min_items: 10, description: "If you buy 20 items or more you get 10% off each items from this merchant")
